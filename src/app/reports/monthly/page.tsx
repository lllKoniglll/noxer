...
function MonthlyReportPageContent() {
  ...
  const selectedYear = chosenYear && years.includes(chosenYear) ? chosenYear : latestYear;
      ...
      <section className={styles.workspace}>
        ...
        <article className={styles.panel}>
          <div className={styles.panelHeader}>
            ...
            <select aria-label="Välj år" value={selectedYear} onChange={(event) => setChosenYear(Number(event.target.value))}>
              {years.map((year) => (
